...
const Experince = ({addExperience,history}) => {
  ...
  let [toDateDisable,toggleDisable] = useState(false);
  ...
  return (
    <Fragment>
      ...
      <form class="form" onSubmit={(e) =>{
        ...
        <div class="form-group">
          <h4>To Date</h4>
          <input type="date" name="to" disabled={toDateDisable ? 'disabled' : ''} value={to} onChange={onChange} />
        </div>
        <div class="form-group">
          <textarea
            name="description"
...
export default connect(null,{addExperience})(withRouter(Experince))
